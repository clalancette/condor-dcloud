...
#     Mandatory : NO
#     Default   : ON
#     May be set to OFF to not using dpkg-shlibdeps to generate
#     package dependecy list.
...
MESSAGE(STATUS "This modified CPackDeb is based on CMake 2.8.0")
...
IF(CPACK_DEBIAN_PACKAGE_SHLIBDEPS)
	...
	IF(SHLIBDEPS_EXECUTABLE)
	  ...
	  MESSAGE( "CPack: - Generating dependency list")
...
# so that empty folders are also included
EXECUTE_PROCESS(COMMAND find -mindepth 1 -maxdepth 1 -type d
	  WORKING_DIRECTORY "${CPACK_TEMPORARY_DIRECTORY}"
	  OUTPUT_VARIABLE CPACK_DEBIAN_PACKAGE_TOP_DIRS
	  OUTPUT_STRIP_TRAILING_WHITESPACE )

STRING(REGEX REPLACE "\n" " " CPACK_DEBIAN_PACKAGE_TOP_DIRS ${CPACK_DEBIAN_PACKAGE_TOP_DIRS})
IF(CPACK_DEBIAN_PACKAGE_DEBUG)
    MESSAGE( "CPackDeb Debug: Top-level directories: ${CPACK_DEBIAN_PACKAGE_TOP_DIRS}")
ENDIF(CPACK_DEBIAN_PACKAGE_DEBUG)
